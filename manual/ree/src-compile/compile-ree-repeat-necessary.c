...
int compile_ree_repeat_necessary (ree_stream *stream, ree_builder *builder){
  ...
  node->type = REE_REPEAT_NECESSARY_NODE;
  node->repeat_necessary_node.repeat_node = nod;
  node->repeat_necessary_node.minimum = minimum;
